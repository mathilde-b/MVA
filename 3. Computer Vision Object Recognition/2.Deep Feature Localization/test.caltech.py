...
model_path = '/Users/mathildebateson/Documents/MVA/Recvis/Caltech/model-0'
...
for start, end in zip(
    ...
    for vis, ori,ori_path, l_name in zip(classmap_vis, current_images, current_image_paths, current_label_names):
        ...
        #vis_path = '/Users/mathildebateson/Documents/MVA/Recvis/Caltech/'+ ori_path.split('/')[-1]
        #vis_path_ori = '/Users/mathildebateson/Documents/MVA/Recvis/Caltech/'+ori_path.split('/')[-1].split('.')[0]+'.ori.jpg'
